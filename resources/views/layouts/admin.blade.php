        	...
        	<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="sidebar-menu">
					<ul class="navbar-nav pt-lg-3">
						<li class="nav-item {{ url()->current() == url('/dashboard-admin') ? 'active' : '' }}">
						...
						<li class="nav-item {{ url()->current() == url('/user') ? 'active' : '' }}">
						...
						<li class="nav-item dropdown {{ url()->current() == url('/permintaan-kategori-admin') ? 'active' : '' }}">
							...
							<div class="dropdown-menu show">
								<div class="dropdown-menu-columns">
									<div class="dropdown-menu-column">
										<a class="dropdown-item" href="{{ url('/permintaan-kategori-admin') }}">
											Permintaan Kategori
										</a>
									</div>
								</div>
						...
						<li class="nav-item {{ url()->current() == url('/kurs-admin') ? 'active' : '' }}">
						...
						<li class="nav-item {{ url()->current() == url('/berita-admin') ? 'active' : '' }}">
							<a class="nav-link" href="{{url('/berita-admin')}}" >
								<span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/ghost -->
