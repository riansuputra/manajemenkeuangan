			...
			<div class="col d-flex flex-column">
				...
				<form action="{{route('updateUser')}}" method="post" autocomplete="off">
					@csrf
						...
						<div class="row g-2">
							<div class="col-auto">
								<h3 class="card-title mt-4">Kategori :</h3>
								<div>
							...
							<div class="col-auto">
								<h3 class="card-title mt-4">Bantuan & Dukungan :</h3>
								<div>
	...
	<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center py-4">
				...
				<div class="text-muted">Apakah anda yakin ingin menghapus data catatan dan anggaran?</div>
			</div>
	...
	<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center py-4">
				<svg xmlns="http://www.w3.org/2000/svg" class="icon mb-2 text-danger icon-lg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.24 3.957l-8.422 14.06a1.989 1.989 0 0 0 1.7 2.983h16.845a1.989 1.989 0 0 0 1.7 -2.983l-8.423 -14.06a1.989 1.989 0 0 0 -3.4 0z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>
				<h3>Konfirmasi Penghapusan</h3>
				<div class="text-muted">Apakah anda yakin ingin menghapus data catatan umum?</div>
			</div>
			<div class="modal-footer">
				<div class="w-100">
					<div class="row">
						...
						<div class="col">
							<form method="post" action="{{route('hapusCatatan')}}">
								@csrf
								@method('DELETE')
								<button type="submit" class="btn btn-danger w-100" data-bs-dismiss="modal">
									Hapus
	...
	<div class="modal-dialog modal-sm modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center py-4">
				<svg xmlns="http://www.w3.org/2000/svg" class="icon mb-2 text-danger icon-lg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.24 3.957l-8.422 14.06a1.989 1.989 0 0 0 1.7 2.983h16.845a1.989 1.989 0 0 0 1.7 -2.983l-8.423 -14.06a1.989 1.989 0 0 0 -3.4 0z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>
				<h3>Konfirmasi Penghapusan</h3>
				<div class="text-muted">Apakah anda yakin ingin menghapus data portofolio?</div>
			</div>
			<div class="modal-footer">
				<div class="w-100">
					<div class="row">
