...
<div class="col">
    ...
    <h2 class="page-title">
        {{ __('simulation.fixed_interest_loan') }}
    </h2>
</div>
						...
						<div class="card-body">
                        	<div class="row-auto">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">{{ __('simulation.duration') }} : </label>
                                        <div class="input-group">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-vcenter card-table table-borderless">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="height:2.93rem;">
                                                        <td style="width:49%;"><strong>{{ __('simulation.monthly_installment') }}</strong></td>
                                                        <td style="width:5%;">:</td>
