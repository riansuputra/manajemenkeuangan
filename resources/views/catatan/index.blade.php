			...
			<div class="card-header">
				<ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
					<li class="nav-item" role="presentation">
						<a href="#tabs-home-5" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">Harian</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="#tabs-profile-5" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Mingguan</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="#tabs-activity-5" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Bulanan</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="#tabs-test-5" class="nav-link" data-bs-toggle="tab" aria-selected="false" role="tab" tabindex="-1">Kalender</a>
					</li>
				</ul>
			</div>
			<div class="card-body">
                ...
                <div class="mb-2">
				  ...
				  <div class="card-footer d-flex align-items-center">
					...
					<div class="tab-pane" id="tabs-test-5" role="tabpanel">
						<div class="row">
							<div class="col-lg-8">
								<h4>Activity tab</h4>
								<div >Donec ac vitae diam amet vel leo egestas consequat rhoncus in luctus amet</div>
