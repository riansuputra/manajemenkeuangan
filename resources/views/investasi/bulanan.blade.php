			...
			<div class="card-header">
				<ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
					<li class="nav-item" role="presentation">
						<a href="{{ route('investasi.bulanan') }}" class="nav-link active" aria-selected="true" role="tab">{{ __('simulation.monthly') }}</a>
					</li>
					<li class="nav-item" role="presentation">
						<a href="{{ route('investasi.target.bulanan') }}" class="nav-link" aria-selected="false" role="tab" tabindex="-1">{{ __('simulation.monthly_target') }}</a>
					</li>
				</ul>
			</div>
			<div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="mb-3">
                                                    <label class="form-label">{{ __('simulation.monthly_investment_fund') }} : </label>
                                                        ...
                                                        <table class="table table-vcenter card-table table-borderless">
                                                            ...
                                                            <tbody>
                                                                <tr style="height:2.93rem;">
                                                                    <td style="width:45%;">{{ __('simulation.total_fund') }}</td>
                                                                    <td style="width:5%;">:</td>
            ...
            <div class="modal-header">
                <div class="table-responsive">
                    <table class="table table-vcenter table-borderless card-table">
                        <tbody>
                            <tr >
                                <td >{{ __('simulation.monthly_fund') }}</td>
                                <td >:</td>
                            </tr>
							...
							<tr >
                                <td >{{ __('simulation.total_fund') }}</td>
                                <td >:</td>
                            </tr>
                            <tr >
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createOrUpdateChart() {
            ...
            chart = new ApexCharts(document.getElementById('chart-demo-pie#3'), {
                ...
                series: chartData,
                labels: ["{{ __('simulation.investment_value') }}", "{{ __('simulation.investment_fund') }}"],
                tooltip: {
                    theme: 'dark',
                    y: {
