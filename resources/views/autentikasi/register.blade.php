                  				...
                  				<form action="{{ route('register') }}" method="post" autocomplete="off">
									@csrf
				  					<div class="mb-3">
                      					...
                      					<input name="name" id="name" type="name" class="form-control" placeholder="Masukkan nama lengkap" autocomplete="off">
                    				</div>
                    				<div class="mb-3">
                      					<label class="form-label">Alamat Email</label>
                      					<input name="email" id="email" type="email" class="form-control" placeholder="Masukkan alamat email" autocomplete="off">
                    				</div>
                    				<div class="mb-2">
