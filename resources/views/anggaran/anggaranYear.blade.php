                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaranWeek') }}" class="nav-link" aria-selected="true" role="tab">Mingguan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaranMonth') }}" class="nav-link" aria-selected="false" role="tab" tabindex="-1">Bulanan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaranYear') }}" class="nav-link active" aria-selected="false" role="tab" tabindex="-1">Tahunan</a>
                        </li>
