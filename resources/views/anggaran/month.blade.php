            ...
            <div class="card" style="height: 31.2rem">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaranMonth') }}" class="nav-link active" aria-selected="false" role="tab" tabindex="-1">Bulanan</a>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                    <div class="divide-y">
                        @if(isset($combinedAnggaranData['Bulanan']))
                            @foreach($combinedAnggaranData['Bulanan'] as $data)
                                @php
