            ...
            <div class="card" style="height: 31.2rem">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaran.year') }}" class="nav-link active" aria-selected="false" role="tab" tabindex="-1">{{ __('budget.yearly') }}</a>
                        </li>
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">{{ __('budget.edit_budget') }}<span id="modaledittitle_{{$data['id']}}" name="modaledittitle"> </span>{{ __('budget.yearly') }}</h5>
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" id="jumlah_edit_{{$data['id']}}" oninput="updateFormattedNumberAnggaran({{$data['id']}})" name="jumlahedit" class="form-control text-end"  placeholder="0" autocomplete="off" placeholder="0" required>
