            ...
            <div class="card" style="height: 31.2rem">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('anggaran.year') }}" class="nav-link active" aria-selected="false" role="tab" tabindex="-1">Tahunan</a>
                        </li>
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Edit Anggaran<span id="modaledittitle_{{$data['id']}}" name="modaledittitle"> </span>Tahunan</h5>
