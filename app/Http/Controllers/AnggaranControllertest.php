...
class AnggaranControllertest extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $anggaranData = $this->fetchAllData('anggarans', $request);
        // dd($anggaranData);
        ...
        $combinedDataAnggaran = $this->mergeKategoriData($anggaranData, $kategoriPengeluaranData, 'id_kategori_pengeluaran', 'kategori_pengeluaran');
        ...
        return view('anggaran.anggaran', [
            ...
            'combinedDataAnggaran' => $combinedDataAnggaran,
